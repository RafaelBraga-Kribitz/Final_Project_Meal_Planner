...
final class UserController extends AbstractController
{
    ...
    public function edit(Request $request, User $user, EntityManagerInterface $entityManager, UserFileUploader $userFileUploader): Response
    {
        $form = $this->createForm(UserType::class, $user);
        $form->handleRequest($request);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // if ($imageFile) {
            //     if($user->getPhoto() != "user.jpg") {
            //         unlink($this->getParameter('photo_directory') . "/" . $user->getPhoto());
            //     }
            //     $imageFileName = $userFileUploader->upload($imageFile);
            //     $user->setPhoto($imageFileName);
            // }

            // elseif($user->getPhoto() != "user.jpg") {
            //     unlink($this->getParameter('photo_directory') . "/" . $user->getPhoto());
